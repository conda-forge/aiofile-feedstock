...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aiofile-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14921&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aiofile-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aiofile` can be installed with:

```
conda install aiofile
```

It is possible to list all of the versions of `aiofile` available on your platform with:
